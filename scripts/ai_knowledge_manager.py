...
class AIKnowledgeBase:
    """
    Flat-file Knowledge Base داخل المستودع:
    - Records: ملفات Markdown مع JSON Frontmatter
    - Tables: مجلد لكل model
    - Index: db_index.json يُعاد بناؤه من الملفات (مصدر الحقيقة)
    - Attachments: _attachments/<external_id>/<filename>
    """
