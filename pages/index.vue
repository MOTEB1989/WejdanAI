<template>
  ...
  >
    <div class="flex gap-4 mb-4">
      ...
      <NuxtLink
        to="/chat"
        class="px-6 py-2 text-sm font-medium text-white transition-all rounded-full shadow-sm bg-blue-500 hover:bg-blue-600 ring-1 ring-blue-600/20 hover:shadow-lg active:shadow-sm"
      >
        💬 Go to Chat
      </NuxtLink>
    </div>
