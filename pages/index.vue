<template>
  ...
  >
    ...
    <NuxtLink
      to="/chat"
      class="mt-6 px-8 py-3 text-sm font-medium text-white transition-all rounded-full shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 hover:shadow-xl active:shadow-md"
    >
      Open Chat →
    </NuxtLink>
